...
interface AuthContextType {
  ...
  loading: boolean;
  signUp: (email: string, password: string, metadata: { username: string; is_student: boolean; currency: string; terms_accepted?: boolean; privacy_accepted?: boolean }) => Promise<{ error: Error | null }>;
...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const signUp = async (email: string, password: string, metadata: { username: string; is_student: boolean; currency: string; terms_accepted?: boolean; privacy_accepted?: boolean }) => {
